            ...
            options: {
              ...
              tags: [
                efficiencyTag ? {
                  ...
                  tag_path: `flow.${flowId}.scan_efficiency_pct`,
                ...
                cyclesTag ? {
                  ...
                  connection_id: systemConnection.id,
                  tag_path: `flow.${flowId}.cycles_per_second`,
                  alias: 'Cycles/Second',
                  color: '#2e7d32',
                  thickness: 2,
                  strokeType: 'solid',
                ...
                memTag ? {
                  ...
                  connection_id: systemConnection.id,
                  tag_path: `flow.${flowId}.memory_peak_mb`,
                ...
                scanTag ? {
                  ...
                  connection_id: systemConnection.id,
                  tag_path: `flow.${flowId}.scan_duration_ms`,
