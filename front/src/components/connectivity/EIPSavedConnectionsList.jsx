...
const EIPSavedConnectionsList = ({ connections, statuses, onStart, onStop, onDelete, onEdit }) => {
      ...
      <Card>
        <CardContent>
          <Typography variant="h6" gutterBottom>
            Saved EtherNet/IP Connections
          </Typography>
          <Typography variant="body2" color="text.secondary">
            No EtherNet/IP connections configured yet. Create one using the form above.
          </Typography>
        </CardContent>
      </Card>
    );
              ...
              {connections.map((conn) => {
                ...
                return (
                  <TableRow key={conn.id} hover>
                    ...
                    <TableCell>
                      <Typography variant="body2">{conn.slot ?? 0}</Typography>
                    </TableCell>
...
export default EIPSavedConnectionsList;
