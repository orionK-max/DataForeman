...
Source: "fix-permissions.bat"; DestDir: "{app}\windows-installer"; Flags: ignoreversion
Source: "README.md"; DestDir: "{app}\windows-installer"; Flags: ignoreversion

[Icons]
; Start menu items
Name: "{group}\Start DataForeman"; Filename: "{app}\windows-installer\start-dataforeman.bat"; WorkingDir: "{app}"; Comment: "Start DataForeman services (Run as Administrator)"
Name: "{group}\Stop DataForeman"; Filename: "{app}\windows-installer\stop-dataforeman.bat"; WorkingDir: "{app}"; Comment: "Stop DataForeman services (Run as Administrator)"
...
Name: "{group}\Fix Permissions"; Filename: "{app}\windows-installer\fix-permissions.bat"; WorkingDir: "{app}"; Comment: "Fix directory permissions if containers fail to start (Run as Administrator)"
...
; Desktop shortcut
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\windows-installer\start-dataforeman.bat"; WorkingDir: "{app}"; Tasks: desktopicon; Comment: "Start DataForeman (Run as Administrator)"
